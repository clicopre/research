# CLICOPRE
 ...
 activity, and voting behaviour in the European Union and the United States.
  ...
  Drawing on large-scale social media and political data, the project combines computational methods, data science, and causal inference to examine how climate shocks move public debate, political
 responses, and accountability around climate policy.

  The project is carried out under the MSCA Seal of Excellence framework at the University of Padua, with the contribution of Fondazione Cassa di Risparmio di Padova e Rovigo.

  This repository contains project code, documentation, and related research materials.

  ## Contact

  Email: clicopre-AT-gmail.com
